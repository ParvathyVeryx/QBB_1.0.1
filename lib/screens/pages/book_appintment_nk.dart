...
//                               value: selectedValue,
//                               items: [selectedValue, ...studyNames]
//                                   .map(
//                                     (studyName) => DropdownMenuItem(
//                                       value: studyName,
...
//                                       selectedValue; // Update visibility based on the selected value
...
//                                 const EdgeInsets.symmetric(horizontal: 16.0),
//                             child: DropdownButton<String>(
//                               value: secondSelectedValue ?? 'Select visit type',
...
//                                     // Navigate to AppointmentBookingPage with the received data
//                                     Navigator.push(
//                                       context,
//                                       MaterialPageRoute(
//                                         builder: (context) =>
...
//                                       SnackBar(
//                                         content: Text(
//                                             'Please select a study and visit type'),
//                                       ),
//                                     );
//                                   }
//                                 }
                    ...
                    child: Padding(
                      ...
                      child: Container(
                        ...
                        child: Padding(
                          ...
                          child: DropdownButton<String>(
                            value: selectedValue,
                            items: ['selectStudies'.tr, ...studyNames]
                                .map(
                                  (studyName) => DropdownMenuItem(
                                    value: studyName,
                                    child: Text(studyName),
                            ...
                            onChanged: (value) {
                              setState(() {
                                ...
                                showSecondDropdown = value !=
                                    'selectStudies'
                                        .tr; // Update visibility based on the selected value

                                int selectedStudyIndex =
                                    studyNames.indexOf(value);
                                selectedStudyId = studyIds[selectedStudyIndex];
                    ...
                    child: Padding(
                      ...
                      child: Container(
                        ...
                        child: Padding(
                          ...
                          child: DropdownButton<String>(
                            value: secondSelectedValue ?? 'selectVisitType'.tr,
                            items: ['selectVisitType'.tr, ...visitTypeNames]
                                .map((visitTypeName) => DropdownMenuItem(
                                      value: visitTypeName,
                                      child: Text(visitTypeName),
                                    ))
